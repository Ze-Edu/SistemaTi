...
<head>
    ...
    <title><?php echo SIS_NAME." - Lista de " .$total_linhas; ?> Tipos</title>
</head>
<body>
...
<h1 class="glyphicon glyphicon-list-alt breadcrumb alert-danger"> Lista de Tipos</h1>
<table class="table table-condensed table-hover tbopacidade">
        ...
        <?php do {?>
            <tr><!-- linha da tabela -->
                ...
                <td>
                    <span class="hiddden-xs"><?php echo $linha['sigla_tipo']?></span>
                </td>
